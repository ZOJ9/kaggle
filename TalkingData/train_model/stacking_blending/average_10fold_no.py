...
def split_data(train,test,train_sp,test_sp):
    ...
    kf = StratifiedKFold(label, n_folds=10, shuffle=True, random_state=6234)    
    ...
    for itrain, itest in kf:
        ...
        #nnet_train(Xtr,ytr,Xte,yte,Xtest,11)
        datas.append(pool.apply_async(nnet_train,args=(Xtr,ytr,Xte,yte,Xtest,11,)))
    pool.close()
    pool.join()
    ...
    pred_test.to_csv("./data/average_pred_no_r6234.csv",index=True)
...
if __name__ == "__main__":
    ...
    train_sp_path = "./sparse_data/train_sp_no_all.data"
    test_sp_path = "./sparse_data/test_sp_no_all.data"
